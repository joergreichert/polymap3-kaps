    ...
    implements AssociationInfo
{
    ...
    public GenericAssociationInfo( Class declaringClass, String accessorName )
    {
        try
        {
            Method accessor = declaringClass.getMethod( accessorName );
            this.qualifiedName = QualifiedName.fromMethod( accessor );
            this.type = getAssociationType(  accessor );
            metainfo = new MetaInfo().withAnnotations( accessor );
