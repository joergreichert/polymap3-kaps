...
//            // Pflanzen
            sub = new SubMonitor( monitor, 10 );
            importEntity( db, sub, KaufvertragComposite.class, "K_BUCH", new EntityCallback<KaufvertragComposite>() {

				@Override
				public void fillEntity(KaufvertragComposite entity, Map<String, Object> builderRow) {
					// mapping eingangsNr
					Object eingangsNummer = builderRow.get("EINGANGSNR");
					Double.toString((Double)eingangsNummer);
				}
			} );
//
//            sub = new SubMonitor( monitor, 10 );
...
//            sub = new SubMonitor( monitor, 10 );
//            importEntity( db, sub, StoerungsArtComposite.class, "Nr_Beeintr�chtigung", null );
//
//            sub = new SubMonitor( monitor, 10 );
...
//            });
//
//            // Biotoptyp (als letztes damit Biotope vollst�ndig kopiert werden)
//            sub = new SubMonitor( monitor, 10 );
    ...
    protected <T extends EntityComposite> void importEntity( 
        ...
        while ((row = table.getNextRow()) != null) {
            ...
            repo.newKaufvertrag(new EntityCreator<KaufvertragComposite>() {
				public void create(KaufvertragComposite prototype) throws Exception {
...
//            repo.newKEntity( type, null, new EntityCreator<T>() {
