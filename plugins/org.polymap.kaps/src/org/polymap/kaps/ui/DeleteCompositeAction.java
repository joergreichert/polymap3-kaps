 ...
 */
public abstract class DeleteCompositeAction<A extends Entity>
        extends Action
        implements ISelectionChangedListener {

    private static Log log = LogFactory.getLog( DeleteCompositeAction.class );
    ...
    public void run() {
        try {
            ...
            PolymapWorkbench.handleError( KapsPlugin.PLUGIN_ID, this, "Fehler beim Löschen.", e );
        }
    }
}
