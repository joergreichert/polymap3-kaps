 ...
 */
public class FlurstueckeStabuFilter
        extends AbstractEntityFilter {

    private static Log log = LogFactory.getLog( FlurstueckeStabuFilter.class );


    public FlurstueckeStabuFilter( ILayer layer ) {
        super( "__kaps--", layer, "für StaBu...", null, 15000, FlurstueckComposite.class );
    }
    ...
    protected Query<? extends Entity> createQuery( IFilterEditorSite site ) {
        ...
        return KapsRepository.instance().findEntities( FlurstueckComposite.class, expr, 0, getMaxResults() );
    }
}
