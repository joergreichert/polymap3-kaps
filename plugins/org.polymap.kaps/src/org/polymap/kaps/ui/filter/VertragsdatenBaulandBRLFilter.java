...
public class VertragsdatenBaulandBRLFilter
    ...
    public VertragsdatenBaulandBRLFilter( ILayer layer ) {
        super( "__kaps--", layer, "nach Nutzung, Datum, Gemeinde...", null, 10000, VertragComposite.class );
    }
    ...
    public Composite createControl( Composite parent, IFilterEditorSite site ) {
        ...
        Composite formField = site.newFormField( result, "nutzung", NutzungComposite.class, field, null, "Nutzung" );
