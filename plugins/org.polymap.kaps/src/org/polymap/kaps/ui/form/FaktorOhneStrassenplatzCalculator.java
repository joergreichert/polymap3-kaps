...
//        names.add( vb.sachwert().qualifiedName().name() );
//
...
//
//        Double sachwert = (Double)values.get( vb.sachwert().qualifiedName().name() );
//        if (sachwert == null) {
//            sachwert = vb.sachwert().get();
//        }
//
//        if (sachwert != null) {
//            if (line3 != null) {
...
////                kaufpreis -= differenz;
////            }
//            if (kaufpreis != null && sachwert != 0.0d) {
//                site.setFieldValue( vb.faktorOhneStrassenplatz().qualifiedName().name(),
//                        getFormatter().format( kaufpreis / sachwert ) );
//            }
//        }
//    }
//
