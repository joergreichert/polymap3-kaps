...
public class Verkaeuferkreis
    ...
    public static final Verkaeuferkreis guenstig = new Verkaeuferkreis( 1, "1 - g�nstig", "g�nstig" );

    public static final Verkaeuferkreis unzureichend = new Verkaeuferkreis( 2, "2 - ung�nstig/unzureichend", "unzureichend" );

    public static final Verkaeuferkreis schlecht = new Verkaeuferkreis( 3, "3 - ung�nstig/schlecht", "schlecht" );
