...
@Mixins({ BodennutzungComposite.Mixin.class, PropertyChangeSupport.Mixin.class,
        ModelChangeSupport.Mixin.class, QiEntity.Mixin.class
// JsonState.Mixin.class
})
@ImportTable("K_BONUTZ")
public interface BodennutzungComposite
    ...
    @Optional
    // STALA
    Association<ArtDesBaugebietesStalaComposite> stala();
    ...
    public static abstract class Mixin
            implements BodennutzungComposite {
