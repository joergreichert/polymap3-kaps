 ...
 */
public class VertragsdatenBaulandGebaudeExporter
        extends AbstractExcelExporter<VertragsdatenBaulandComposite> {

    public VertragsdatenBaulandGebaudeExporter() {
    ...
    private List<Value> createValues( VertragComposite vertrag, VertragsdatenBaulandComposite vdc,
        ...
        if (hausNummer == null) {
            errors.add( error( flurstueck, "Keine Hausnummer gefunden!" ) );
            return result;
        }
        ...
        result.add( new Value( "Haus-Nr.", hausNummer ) );
